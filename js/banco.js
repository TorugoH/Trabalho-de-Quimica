...
busca.addEventListener('click', function () {
    let item = document.querySelector('.item')
    item=item.value.replace(/\s/g,"_");
    item=item.toLocaleLowerCase()
    
    /*aqui adiciona o objeto pesquisado*/
    nome.innerHTML = dados[item].name;
    descri.innerHTML = dados[item].composicao;
    resu.innerHTML = dados[item].descricao;
    acompanhamento.innerHTML = dados[item].acompanhamentos;
});
